...
public class DragNDropListView extends ListView {
    ...
    private int myPointToPosition(int x, int y) {
        ...
        // check if the item has been dragged to the bottom of the list
        ...
        switch (action) {
            ...
            default:
                ...
                if (mStartPosition != INVALID_POSITION) {
                    ...
                    int actualPosition =  myPointToPosition(x, y);
                    // if the item was dragged past the end of the list, put it at the end of the list
                    if (actualPosition == END_OF_LIST_POSITION) {
                        actualPosition = getCount() - 1;
                    }
                    else if (actualPosition > (getCount() - getFooterViewsCount()) - 1) {
    ...
    private void startDrag(int childIndex, int y) {
        ...
        // make the dragging image a little transparent.
        v.setAlpha(0.7f);
